...
class MayaHttpRequestor():
    ...
    def process(self, query, history):
        self.string_value['query'] = query
        self.string_value['history'] = history
        self.body["tensorFeatures"]['data']['stringValues'].append(self.string_value)
