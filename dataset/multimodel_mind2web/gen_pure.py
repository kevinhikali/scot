...
import pandas as pd
import json
from infer_utils import map_action_desc_history, map_to_actions
from infer_bbox_pu import prompt_f as user_prompt_f
...
class SCOTInfer():
    def __init__(self, config):
        INFO('n_chunks chunk_index inferer(useless)')
        cfg = config
